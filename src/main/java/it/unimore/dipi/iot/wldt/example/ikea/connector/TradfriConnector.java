...
public class TradfriConnector {
    ...
    private Logger logger = Logger.getLogger(TradfriConnector.class.getName());

    public int timeout = 500; // milliseconds

    public TradfriConnector(String gatewayIp, String securityKey) throws TradfriException {
    ...
    public CoapResponse get(String path) throws TradfriException {
        Logger logger = Logger.getLogger(TradfriConnector.class.getName());
