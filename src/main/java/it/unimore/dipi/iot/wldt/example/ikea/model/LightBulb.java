...
public class LightBulb {
    ...
    public void setOn(boolean on) throws TradfriException {
        try {
            ...
            Logger.getLogger(TradfriConnector.class.getName()).log(Level.SEVERE, null, ex);
    ...
    public static void set(TradfriConnector gateway, int bulbId, JSONObject settings) throws TradfriException {
        JSONObject json = new JSONObject();
        JSONArray array = new JSONArray();
        array.put(settings);
        try {
